...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 09, 2025 at 05:46 PM
...
(5, '2025_11_08_200423_create_companies_table', 1),
(6, '2025_11_08_200447_create_short_urls_table', 2);
...
CREATE TABLE `users` (
  ...
  `role` enum('super_admin','admin','member','sales','manager') NOT NULL DEFAULT 'member',
